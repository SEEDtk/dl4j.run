...
public class TabbedDataSetReader implements Iterable<DataSet>, Iterator<DataSet> {
    ...
    private class Entry {
        ...
        public Entry() {
            this.feature = new double[getWidth()];
            this.label = 0;
     ...
     * @throws IOException
     */
    private void setup(String labelCol, List<String> labels, List<String> metaCols) throws IOException {
    ...
    public DataSet next() {
        ...
        NDArray features = new NDArray(this.buffer.size(), this.getWidth());
