...
public enum LossFunctionType {
     ...
     *
     * @param defaultFunction	default to use if no special function is required
     */
    public Activation getOutActivation(Activation defaultFunction) {
        Activation retVal;
        switch (this) {
        case XENT :
